                            ...
                            <form id="contact-form" action="#" method="post">
                                ...
                                <div class="single-contact-form">
                                    <div class="contact-box subject">
                                        ...
                                        <span class="field_errror" id="subject_error"> </span>
                                    </div>
                                </div>
                                <div class="single-contact-form">
                                    <div class="contact-box message">
                                        <textarea name="message" id="msg" placeholder="Your Message"></textarea>
                                        <span class="field_errror" id="msg_error"> </span>
                                    </div>
                                </div>
                                <div class="contact-btn">
                                    <button type="button" onclick="sendMessage()" id="submit" class="fv-btn">Send MESSAGE</button>
                                </div>
                            </form>
...
function sendMessage() {
    ...
    var is_error="";
if (name=="") {
    jQuery("#name").css("border", "#f70505 solid 3px");
    is_error='yes';
    
}
if (email=="") {
    jQuery("#email").css("border", "#f70505 solid 3px");
    is_error='yes';
}if (mobile=="") {
    jQuery("#mobile").css("border", "#f70505 solid 3px");
    is_error='yes';
}if (msg=="") {
    jQuery("#msg").css("border", "#f70505 solid 3px");
    is_error='yes';}
