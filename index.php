                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                        <div class="slide">
                            <div class="slider__inner">
                                ...
                                <h1>NOISE PULSE</h1>
                                <div class="cr__btn">
                                    <a href=product-details.php?id=15">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="htc__product__container">
            <div class="row">
                <div class="product__list clearfix mt--30">
                    ...
                    <?php $latest_product = getProduct($conn, 4);
                            ...
                            <div class="category">
                                <div class="ht__cat__thumb">
                                    <a href="product-details.php?id=<?= $product['id'] ?>">
                                        <img src="media/product/<?php echo $product['image'] ?>" alt="product images">
                                    </a>
                                </div>
                                <div class="fr__product__inner">
                                    ...
                                    <ul class="fr__pro__prize">
                                        <li class="old__prize" STYLE="text-decoration:line-through">&#8377
